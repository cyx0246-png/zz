...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: '是必要之恶，通过平衡各方势力，才能真正干成大事。（编者按：此处对应李达康/高育良逻辑）', scores: { strategicManeuvering: 2 } },
      { text: '必须选择最有胜算的一方，那是实现个人抱负的捷径。', scores: { powerAmbition: 2 } },
      { text: '我连队都不想进，最好谁也别注意到我。', scores: { powerAmbition: -2 } }
    ]
  },
  {
    id: 7,
  ...
  },
  {
    ...
    options: [
      ...
      { text: '在宏大的知识、历史或科学研究中寻找慰藉，觉得人类社会很无聊。（注：孙连城逻辑）', scores: { powerAmbition: -2, socialResponsibility: -1 } },
