...
export const characters: Character[] = [
  ...
  },
  {
    ...
    famousQuotes: [
      '“共产党人是为人民服务的，不是为人民币服务的！”',
      '“当年我虚报两岁入党，拿到了背炸药包的特权。”'
    ],
  ...
  },
  {
    ...
    famousQuotes: ['“这么多年了，我易学习就没指望过他李达康提拔我！”'],
  ...
  },
  {
    ...
    famousQuotes: ['“办案要讲究程序，没有手续，咱们一步都不能动！”'],
  ...
  },
  {
    ...
    famousQuotes: ['“大家在这个世上混，谁都不容易。我们输在起跑线上，就只能拿命拼！”'],
    image: 'https://picsum.photos/seed/xq/400/600',
    traits: ['顶级情商', '慕强攀附', '八面玲珑'],
    vector: {
      powerAmbition: 9,
      ruleIntegrity: 1,
      socialResponsibility: 2,
      emotionalDetachment: 8,
      strategicManeuvering: 9
    }
  },
  {
    id: 'zhao-donglai',
    name: '赵东来',
    title: '京州市公安局局长',
    description: '你是那种让人又爱又恨的“兵痞”型干将。你性格粗犷但心思细腻，为了心中的正义 and 保护自己的人，你敢于打破常规，甚至不惜游走在灰色的边缘。',
    suggestion: '你的江湖气是你最大的魅力，但也容易成为别人攻击你的把柄。',
    famousQuotes: ['“如果是头狼，就算把牙拔了，他也还会咬人！”'],
    image: 'https://picsum.photos/seed/zdl/400/600',
  ...
  },
  {
    ...
    famousQuotes: ['“我一分钱都没花！不敢花啊！我家祖祖辈辈是农民，穷怕了！”'],
    image: 'https://picsum.photos/seed/zdh/400/600',
